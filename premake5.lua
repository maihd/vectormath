...
do
    ...
    files {
        ...
        path.join(ROOT_DIR, "VectorMath.h"),
        path.join(ROOT_DIR, "VectorMathScalar.h"),
        path.join(ROOT_DIR, "VectorMathSimd.h"),
        path.join(ROOT_DIR, "VectorMath.h"),
        path.join(ROOT_DIR, "VectorTypes.h"),
        path.join(ROOT_DIR, "VectorTypes.natvis"),
