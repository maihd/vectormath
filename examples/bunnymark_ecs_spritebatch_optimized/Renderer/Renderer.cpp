...
void SpriteBatch_Init(SpriteBatch* spriteBatch, const SpriteSheet* sheet, int capacity)
{
...
void SpriteBatch_End(SpriteBatch* spriteBatch)
{
    ...
    glBindBuffer(GL_ARRAY_BUFFER, spriteBatch->verticesBufferId);
    glBufferData(GL_ARRAY_BUFFER, sizeof(vec2) * vertexCount, spriteBatch->vertices, GL_STREAM_DRAW);

    glBindBuffer(GL_ARRAY_BUFFER, spriteBatch->uvsBufferId);
    glBufferData(GL_ARRAY_BUFFER, sizeof(vec2) * vertexCount, spriteBatch->uvs, GL_STREAM_DRAW);

    glBindBuffer(GL_ARRAY_BUFFER, spriteBatch->colorsBufferId);
    glBufferData(GL_ARRAY_BUFFER, sizeof(vec3) * vertexCount, spriteBatch->colors, GL_STREAM_DRAW);
