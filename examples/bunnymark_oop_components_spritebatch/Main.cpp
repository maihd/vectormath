...
int main(const int argc, const char* argv[])
{
    ...
    WindowDesc window;
    window.title = "VectorMath Examples + OOP Components + SpriteBatch";
    window.width = 1280;
    window.height = 720;
    ...
    Renderer_LoadSpriteSheet(&spriteSheet, "../../assets/sprites.png", spriteCount);

    int objectCount = 100000;
    Game_Setup(&spriteSheet, objectCount);
