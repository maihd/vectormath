...
void ThreadMutex::Create(void)
{
    ::InitializeCriticalSection((LPCRITICAL_SECTION)this);
}

void ThreadMutex::Destroy(void)
{
...
void ThreadSignal::Create(void)
{
    ::InitializeConditionVariable((CONDITION_VARIABLE*)this);
}

void ThreadSignal::Destroy(void)
{
}
...
void ThreadSemaphore::Create(int count)
{
    this->count = count;
    this->mutex.Create();
    this->signal.Create();
