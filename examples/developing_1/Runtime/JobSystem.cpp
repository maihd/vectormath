...
void JobSystem_Create(JobSystem* jobSystem, int requestWorkers)
{
    ...
    jobSystem->mutex.Create();
    jobSystem->idleSignal.Create();
    jobSystem->queueSignal.Create();
...
void JobSystem_Destroy(JobSystem* jobSystem)
{
    ...
    jobSystem->queueSignal.Destroy();
    jobSystem->idleSignal.Destroy();
    jobSystem->mutex.Destroy();
}
